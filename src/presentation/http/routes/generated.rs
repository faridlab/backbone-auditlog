...
use super::{
    audit_trail_handler::create_audit_trail_read_routes,
};
...
pub fn configure_routes(services: HttpServices) -> Router {
    Router::new()
        // AuditTrail routes (READ-ONLY — append-only/event-sourced entity; writes arrive via the event handlers)
        .merge(create_audit_trail_read_routes(services.audit_trail))
}
