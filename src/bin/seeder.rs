//! Database seeder binary for module: auditlog
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin auditlog-seeder
//! Or via CLI: backbone seed run --module auditlog
//!
...
// Import seeders
use backbone_auditlog::seeders::SeedAuditTrailSeeder;
use backbone_auditlog::seeders::Seeder;
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: auditlog");
    println!();

    // Register seeders in order
    let mut seeders: Vec<Box<dyn Seeder + Send + Sync>> = Vec::new();
    seeders.push(Box::new(SeedAuditTrailSeeder::new()));
