//! Specifications for AuditTrail aggregate
//!
...
// Each predicate implements `Specification<AuditTrail>` and can be combined
...
//
// pub struct ActiveAuditTrailSpec;
// impl Specification<AuditTrail> for ActiveAuditTrailSpec {
//     fn is_satisfied_by(&self, e: &AuditTrail) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
