//! Domain policy for AuditTrail aggregate
//!
...
/// Domain policy for AuditTrail — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<AuditTrail>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type AuditTrailDomainPolicy = PermitAllPolicy<AuditTrail>;
